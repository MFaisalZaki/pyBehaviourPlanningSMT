...
python $(pwd)/paper_experiments/generate-benchmark-slurm-tasks.py --planning-type oversubscription --sandbox-dir $(pwd)/sandbox-benchmark-oversubscription --planning-tasks-dir $(pwd)/sandbox-benchmark/classical-domains/oversubscription
