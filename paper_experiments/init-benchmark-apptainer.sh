...
python $(pwd)/paper_experiments/apptainer-generate-benchmark-slurm-tasks.py --planning-type classical        --sandbox-dir $(pwd)/sandbox-benchmark-classical        --planning-tasks-dir $(pwd)/sandbox-benchmark/classical-domains/classical --resources-dir $(pwd)/paper_experiments/data/classical-domains-ru-info
python $(pwd)/paper_experiments/apptainer-generate-benchmark-slurm-tasks.py --planning-type oversubscription --sandbox-dir $(pwd)/sandbox-benchmark-oversubscription --planning-tasks-dir $(pwd)/sandbox-benchmark/classical-domains/classical
python $(pwd)/paper_experiments/apptainer-generate-benchmark-slurm-tasks.py --planning-type numerical        --sandbox-dir $(pwd)/sandbox-benchmark-numerical        --planning-tasks-dir $(pwd)/sandbox-benchmark/numeric-domains             --resources-dir $(pwd)/paper_experiments/data/functions-domains-info
